...
export default function PricingPage() {
  ...
  const plans: Plan[] = [
    {
      name: t('Pricing.plans.plugin.name'),
      price: isCommercial ? "1000" : "5",
      description: t('Pricing.plans.plugin.description'),
      features: [
        { name: t('Pricing.plans.plugin.features.performance'), included: true },
        { name: t('Pricing.plans.plugin.features.compatibility'), included: true },
        { name: t('Pricing.plans.plugin.features.maintenance'), included: true },
        { name: t('Pricing.plans.plugin.features.support'), included: true },
        { name: t('Pricing.plans.plugin.features.documentation'), included: true },
      ],
    },
    {
      name: t('Pricing.plans.mod.name'),
      price: "Custom",
      description: t('Pricing.plans.mod.description'),
      customLayout: true,
    },
  ];
              ...
              {!plan.customLayout ? (
                <>
                  ...
                  <div className="flex items-baseline gap-1 mb-4">
                    <span className="text-zinc-400 text-sm mr-1">{t('Pricing.startingAt')}</span>
                  ...
                  <motion.a
                    href="https://discord.devio-agency.fr"
                    target="_blank"
                ...
                <>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <h4 className="text-lg font-medium text-white">{t('Pricing.plans.mod.included.title')}</h4>
                      <p className="text-zinc-400">{t('Pricing.plans.mod.included.subtitle')}</p>
                      <ul className="list-disc list-inside text-zinc-300 space-y-2 ml-2">
                        {t.raw('Pricing.plans.mod.included.items').map((item: string, index: number) => (
                    ...
                    <div className="space-y-3">
                      <h4 className="text-lg font-medium text-white">{t('Pricing.plans.mod.process.title')}</h4>
                      <ol className="space-y-4">
                        {t.raw('Pricing.plans.mod.process.steps').map((step: string, index: number) => (
